				...
				<div class="col-sm-12">
	                ...
	                <div class="col-sm-8">
	                	<div class="btn-group hidden-xs" role="group">
	                        ...
	                        <button type="button" class="btn btn-danger" data-toggle="modal" id="delete" name="smdic/delete.do">
		                 ...
		                 <table class="table table-striped table-bordered table-hover table-condensed">
					        ...
					        <tbody>
					        	...
					        	<c:forEach var="e" items="${page.list}" varStatus="v">
						            <tr>
						                <td><input type="checkbox" name="ids" value="${e.dicid}"/></td>
										<td>${e.dictype}</td>
						                <td>${e.dicval}</td>
										<td>${e.dicremarks}</td>
										<td>${e.diccreateuser}</td>
										<td>${e.dicupdateuser}</td>
						            </tr>
					            </c:forEach>
					        </tbody>
					    </table>
